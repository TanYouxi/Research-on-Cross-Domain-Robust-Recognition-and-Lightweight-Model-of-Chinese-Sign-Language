# -*- coding: utf-8 -*-
"""
M3+KF: RGB + ST-GCN Skeleton + Perception Alignment + CLIP Semantic Alignment + Keyframe Sampling for CE-CSL
...
CONFIG = {
    ...
    "experiment_name": "m3_kf_rgb_skel_align_clip_stgcn",
    "output_dir": f"{DATA_ROOT}/experiments/m3_kf_rgb_skel_align_clip_stgcn",
    "seed": 42,
