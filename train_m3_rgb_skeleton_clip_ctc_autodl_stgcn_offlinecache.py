# -*- coding: utf-8 -*-
"""
M3-offline-cache: RGB + ST-GCN Skeleton + Perception Alignment + Offline-CLIP Semantic Alignment for CE-CSL
...
CONFIG = {
    ...
    "experiment_name": "m3_rgb_skel_align_clip_stgcn_offcache",
    "output_dir": f"{DATA_ROOT}/experiments/m3_rgb_skel_align_clip_stgcn_offcache",
    "seed": 42,
